...
class _ChatRoomScreenState extends State<ChatRoomScreen> {
  ...
  Future<void> _sendDocument() async {
    try {
      ...
      final path = 'documents/$uid/${DateTime.now().millisecondsSinceEpoch}_${file.name}';
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                _AttachItem(icon: Icons.photo_rounded, label: 'Galeri',
                  color: const Color(0xFF7C4DFF),
                  onTap: () { Navigator.pop(ctx); _sendImage(); }),
                _AttachItem(icon: Icons.camera_alt_rounded, label: 'Kamera',
                  color: const Color(0xFFE91E63),
                  onTap: () { Navigator.pop(ctx); _sendImage(fromCamera: true); }),
                _AttachItem(icon: Icons.insert_drive_file_rounded, label: 'Dokumen',
                  color: const Color(0xFF2196F3),
                  onTap: () { Navigator.pop(ctx); _sendDocument(); }),
                _AttachItem(icon: Icons.location_on_rounded, label: 'Lokasi',
              ...
              builder: (ctx, snap) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (ctx, i) {
                    ...
                    final nextMsg = i > 0 ? reversed[i - 1] : null;
                    ...
                    return Column(
                      children: [
                        ...
                        if (showDate)
                          _DateDivider(timestamp: msg['timestamp']?.toString() ?? ''),
                      ],
                    );
                  },
                );
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Icon(
                      _isRecording ? Icons.stop_rounded
                          : _hasText ? Icons.send_rounded
                          : Icons.mic_rounded,
                      color: Colors.white,
                      size: 22,
                    ),
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        width: 36, height: 36,
                        decoration: BoxDecoration(
                          color: isMe ? Colors.white24 : AppTheme.primaryGreen,
                          shape: BoxShape.circle,
                        ),
                        child: Icon(
                          playingUrl == mediaUrl
                ...
                children: [
                  ...
                  if (isMe) ...[
                    ...
                    Icon(
                      ...
                      size: 14,
                      color: status == 'read'
                        ? Colors.lightBlueAccent : Colors.white60,
                    ),
                  ],
                ],
              ),
