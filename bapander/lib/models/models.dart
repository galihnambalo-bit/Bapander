...
class MessageModel {
  ...
  factory MessageModel.fromMap(Map<String, dynamic> map, String id) {
    ...
    timestamp: map["timestamp"] is String ? DateTime.parse(map["timestamp"]).toLocal().millisecondsSinceEpoch : (map["timestamp"] is int ? map["timestamp"] : (map["timestamp"] as DateTime).toLocal().millisecondsSinceEpoch),
